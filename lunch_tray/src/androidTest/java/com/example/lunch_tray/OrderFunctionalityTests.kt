...
import com.example.lunch_tray.ui.order.AccompanimentMenuFragment
import com.example.lunch_tray.ui.order.EntreeMenuFragment
import com.example.lunch_tray.ui.order.SideMenuFragment
...
class OrderFunctionalityTests: BaseTest() {
    ...
    /**
     * Test subtotal in full order flow
     */
    @Test
    fun `subtotal_updates_in_full_order_flow`(){
        ...
        // Check that subtotal has updated
        onView(withId(R.id.subtotal)).perform(click())
