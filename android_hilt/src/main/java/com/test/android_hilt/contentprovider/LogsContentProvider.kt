package com.test.android_hilt.contentprovider
...
/** The authority of this content provider */
private const val AUTHORITY = "com.test.android_hilt.provider"
...
class LogsContentProvider: ContentProvider() {
    ...
    override fun query(
        ...
        return if (code == CODE_LOGS_DIR || code == CODE_LOGS_ITEM){
            ...
            throw IllegalStateException("Unknown URI: $uri")
        }
    }
