...
import com.onethefull.data_store.databinding.FragmentLetterListBinding
import kotlinx.coroutines.launch

/**
 * @author jskim
 * @email jskim@1thefull.com
 * @created 2022/08/26 6:13 오후
 * @desc
 */
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        return when(item.itemId){
            R.id.action_switch_layout->{
                ...
                lifecycleScope.launch { SettingsDataStore.saveLayoutToPreferencesStore(
